...
function PushToTableee(){
    var content = document.getElementById("transfer2").text = strUser; 
    var x = document.getElementById("transfer2");
      if (x.style.display === "block") {
          x.style.display = "none";
      } else {
          x.style.display = "block";
...
//PushFrom3.-to-4.   UNHIDE
function PushToTable2(){
  ...
  //PushFrom3.-to-4.   UNHIDE
function PushToTable3(){
    var x = document.getElementById("ovo");
    if (x.style.display === "block") {
        x.style.display = "none";
    } else {
        x.style.display = "block";
